...
/**
 * Sends a {@link OrdType#LIMIT} order at the best price on the side of this {@link VwapExecution}. If there is not
 * price available, this {@link SendLimitBestPriceCorrectSide} finishes.
 *
 * @author Jakub D Kozlowski
 * @since 0.8
 */
public final class SendLimitBestPriceCorrectSide implements State {
