 ...
 * **************************************************************
 */
package eugene.market.ontology.internal;
 ...
 */
public class ExtendedSchema extends TermSchema {
    public static final String         BASE_NAME = "Primitive";
    private static ExtendedSchema baseSchema = new ExtendedSchema();

    /**
     * Construct a schema that vinculates an entity to be a generic
     * primitive element
     */
    private ExtendedSchema() {
        super(BASE_NAME);
    }

    /**
     * Creates a <code>ExtendedSchema</code> with a given type-name.
     *
     * @param typeName The name of this <code>ExtendedSchema</code>.
     */
    public ExtendedSchema(Class typeName) {
    ...
    public AbsObject newInstance() throws OntologyException {
        return new AbsExtendedPrimitive(getTypeName());
    } 
  	...
  	public void validate(AbsObject abs, Ontology onto) throws OntologyException {
  		...
  		if (!(abs instanceof AbsExtendedPrimitive)) {
	...
	public boolean isAssignableFrom(ObjectSchema s) {
		if (s != null && s instanceof ExtendedSchema) {
