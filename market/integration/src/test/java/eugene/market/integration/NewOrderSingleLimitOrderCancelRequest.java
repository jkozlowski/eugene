 ...
 * @since 0.6
 */
public class NewOrderSingleLimitOrderCancelRequest extends AbstractMarketAgentTest {

    @Test
    public void newOrderSingleLimitOrderCancelRequest() throws StaleProxyException, InterruptedException {
