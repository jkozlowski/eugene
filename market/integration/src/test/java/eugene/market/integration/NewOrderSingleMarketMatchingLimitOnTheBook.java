 ...
 * @since 0.6
 */
public class NewOrderSingleMarketMatchingLimitOnTheBook extends AbstractMarketAgentTest {

    @Test
    public void newOrderSingleMarketMatchingLimitOnTheBook() throws StaleProxyException, InterruptedException {
